<%@ Page Title="" Language="C#" MasterPageFile="~/adminmaster.Master" AutoEventWireup="true" CodeBehind="AddBrand.aspx.cs" Inherits="oneceagain.AddBrand" %>
            ...
            <asp:repeater ID="rptrBrands" runat="server">
                ...
                <ItemTemplate>
                    <tr>
                        <th> <%# Eval("BrandID") %> </th>
                        <td><%# Eval("Name") %>   </td>
                        <td><a href="EditBrand.aspx" style="text-decoration:none;">Edit</a></td>
                    </tr>
                </ItemTemplate>
                <FooterTemplate>
                    </tbody>
