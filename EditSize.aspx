<%@ Page Title="" Language="C#" MasterPageFile="~/adminmaster.Master" AutoEventWireup="true" CodeBehind="EditSize.aspx.cs" Inherits="oneceagain.EditSize" %>
                ...
                <div class="col-sm-6">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <br />
                           <asp:TextBox ID="txtFilterGrid1Record" style="border:2px solid blue" CssClass="form-control" runat="server" placeholder="Search Category...." onkeyup="Search_Gridview"></asp:TextBox>
                            <hr />
